FUNCTION z_edu_rfc_read_docentes_v2.
*"--------------------------------------------------------------------
*"*"Interfase local
*"  IMPORTING
...
* Creado el: 24/09/2019 .                                              *
* Orden de Transporte: DCEK911050 PS EDU: GF Z_EDU_RFC_READ_DOCENTES_V2*
* Frente: Educación                                                    *
* Funcion Origen: Z_EDU_RFC_READ_DOCENTES - V02                        *
* Descripción: Se copia la funcion y se realizan ajustes para corregir *
*              filtros para fechas de seleccion                        *
*&---------------------------------------------------------------------*
