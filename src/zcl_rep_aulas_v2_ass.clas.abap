class ZCL_REP_AULAS_V2_ASS definition
  public
...
public section.
  ...
  methods BUSCAR_AULAS_DISPONIBLES
    importing
      !IS_EVENTO_AULA type ZEDU_EVENTOS_AULA_V2
  ...
  methods BUSCAR_EVENTOS
    ...
    exporting
      !ET_EVENTOS type ZEDU_T_EVENTOS_AULA_V2 .
  ...
  methods BUSCAR_PROGRAMA_EVENTO
    importing
      !IS_EVENTO type ZEDU_EVENTOS_AULA_V2
    exporting
...
CLASS ZCL_REP_AULAS_V2_ASS IMPLEMENTATION.
...
*       G1024           =
  ...
  METHOD buscar_eventos.
    ...
    DATA: ls_hrobject        TYPE  hrobject,
          ...
          lt_eventos         TYPE  zedu_t_eventos_aula_v2,
          ls_eventos         TYPE  zedu_eventos_aula_v2,
